...
public interface ValidationConfig
{
    ...
    {
        /**
         * The proxy interfaces require an annotation.
         */
        REQUIRES_ANNOTATION(true),

        /**
         * The proxy interfaces do not require an annotation.
         */
        NO_ANNOTATION(false);
    ...
    {
        /**
         * An {@link com.lmax.disruptor.ExceptionHandler} is required.
         */
        REQUIRED(true),

        /**
         * An {@link com.lmax.disruptor.ExceptionHandler} is not required.
         */
        NOT_REQUIRED(false);
